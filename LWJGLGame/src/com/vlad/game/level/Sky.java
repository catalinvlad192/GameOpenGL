...
public class Sky {
	...
	public Sky()
	{
		System.out.println("[Sky] Drawing sky");
		...
		texture = new Texture("res/map/sky.png");
	}
	...
	public void render()
	{
		...
		Cache.SKY.enable();
		mesh.bind();
		Cache.SKY.setUniformMat4f("vw_matrix", Matrix4f.translate(new Vector3f(1.0f, 0.0f, 0.0f)));
		mesh.render();
		Cache.SKY.disable();
		texture.unbind();
